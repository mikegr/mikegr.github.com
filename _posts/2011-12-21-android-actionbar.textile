...
If you have tabs and disable the logo, icon and title, the tabs move to the top of the screen and stretch to the whole width.
On a smartphone with Ice Cream Sandwich and portrait modus action icon are always moved to the next line, even if there enough space to place a single icon in the same row.   
